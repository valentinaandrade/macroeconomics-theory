...
[~, ~, ~, ~, Trayectoria_Act_1, Trayectoria_Cons_1, Trayectoria_Laboral_1 ,~]=CicloVidaOfLaboralcRestricciones(T,psi,beta,r_1,b);

Of_Activos_1=sum(Trayectoria_Act_1)/T;

[~, ~, ~, ~, Trayectoria_Act_0, Trayectoria_Cons_0, Trayectoria_Laboral_0 ,~]=CicloVidaOfLaboralcRestricciones(T,psi,beta,r_0,b);
...
[~,~,~,~,Trayectoria_Activos_bar,~,~,~]=CicloVidaOfLaboralcRestricciones(T, psi, beta, r_bar,b);
Of_Activos_bar=sum(Trayectoria_Activos_bar)/T;
error=abs(Of_Activos_bar);
...
[~,~,~,~,Trayectoria_Activos_bar,Trayectoria_Cons_bar,Trayectoria_Laboral_bar,~]=CicloVidaOfLaboralcRestricciones(T, psi, beta, r_bar,b);
Of_Activos_bar=sum(Trayectoria_Activos_bar)/T;
...
[~,~,~,~,Trayectoria_Activos_0,~,~,~]=CicloVidaOfLaboralcRestricciones(T, psi, beta, r_0, b(i));

Of_Activos_0=sum(Trayectoria_Activos_0)/T;

[~,~,~,~,Trayectoria_Activos_1,~,~]=CicloVidaOfLaboralcRestricciones(T, psi, beta, r_1, b(i));
...
Of_Activos_1=sum(Trayectoria_Activos_1)/T;
    ...
    [~,~,~,~,Trayectoria_Activos_bar,Trayectoria_Cons_bar,Trayectoria_Laboral_bar,~]=CicloVidaOfLaboralcRestricciones(T, psi, beta, r_bar, b(i));
    Of_Activos_bar=sum(Trayectoria_Activos_bar)/T;
    error=abs(Of_Activos_bar);
