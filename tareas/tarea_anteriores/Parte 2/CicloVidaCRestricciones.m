function [V1, Api, Apf, Cpf, lt_activos, lt_consumo, lt_ahorro,gamma, y]=CicloVidaCRestricciones(T,sigma,beta,r,b)
...
y=zeros(1,T);
for i=1:T
  gamma(i) = ((40/(0.4*i*(2*pi).^(1/2)))*exp((-1/2)*((log(i)-log(32.5))/0.4).^2)+0.4);
  y(i) = gamma(i)*w(r);
end
