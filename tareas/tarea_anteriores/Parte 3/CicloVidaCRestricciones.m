function [V1, Api, Apf, Cpf, Trayectoria_Act, Trayectoria_Cons, Trayectoria_Ahorro]=CicloVidaCRestricciones(T,sigma,beta,r,b)
...
V1(Restr_Act:end, T)=utility(c_Final, sigma);%Value function en último periodo.
...
%Consumo
Trayectoria_Cons=Trayectoria_Act(1:65)*(1+r)+y-Trayectoria_Act(2:66);
